...
import { deleteWithPhpSniper, deleteWithoutPhpSniper, insertWithOutPhpSniper, insertWithPhpSniper, selectRowWithPhpSniper, selectRowWithoutPhpSniper, selectWithPhpSniper, selectWithoutPhpSniper, updateWithPhpSniper, updateWithoutPhpSniper } from '../store';
...
const Introduction = () => {
    ...
    return (
        <div className='flex flex-col space-y-10 px-3'>
            ...
            <div className="flex flex-col md:flex-row md:space-x-10">
                ...
                <Snippet code={insertWithOutPhpSniper} />
                </div>
                <div className="w-full">
                <h1 className='text-2xl font-bold gradient-text'>After</h1>
                <Snippet code={insertWithPhpSniper} />
                </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row md:space-x-10">
                <div className="w-full">
                <h1 className='text-2xl font-bold gradient-text'>Before</h1>
                <Snippet code={selectWithoutPhpSniper} />
                </div>
                <div className="w-full">
                <h1 className='text-2xl font-bold gradient-text'>After</h1>
                <Snippet code={selectWithPhpSniper} />
                </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row md:space-x-10">
                <div className="w-full">
                <h1 className='text-2xl font-bold gradient-text'>Before</h1>
                <Snippet code={selectRowWithoutPhpSniper} />
                </div>
                <div className="w-full">
                <h1 className='text-2xl font-bold gradient-text'>After</h1>
                <Snippet code={selectRowWithPhpSniper} />
                </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row md:space-x-10">
                <div className="w-full">
                <h1 className='text-2xl font-bold gradient-text'>Before</h1>
                <Snippet code={updateWithoutPhpSniper} />
                </div>
                <div className="w-full">
                <h1 className='text-2xl font-bold gradient-text'>After</h1>
                <Snippet code={updateWithPhpSniper} />
                </div>
            </div>
