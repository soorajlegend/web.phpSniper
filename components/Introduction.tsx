...
import { insertWithOutPhpSniper, insertWithPhpSniper, selectWithPhpSniper, selectWithoutPhpSniper } from '../store';
            ...
            <div className='h-screen flex space-x-0 flex-col md:space-x-10 md:flex-row items-center'>
                <div className="w-full flex flex-col space-y-3">
                    ...
                    <div className="flex flex-col md:flex-row  md:space-x-5">
                        ...
                        <div className="flex items-center rounded-xl bg-white shadow-lg darh:bg-gray-800 px-4 space-x-3">
